...
$str = file_get_contents("http://www.haoweichi.com/Others/ao_da_li_ya_ren_shen_fen_sheng_cheng");
...
//echo $address;
file_put_contents("data/Australian.txt",$address.PHP_EOL,FILE_APPEND);
