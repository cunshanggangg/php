...
set_time_limit(0);
//胡志明市酒店
//$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g293925-Ho_Chi_Minh_City-Hotels.html");
//河内酒店
//$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g293924-Hanoi-Hotels.html");
//岘港酒店
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g298085-Da_Nang_Quang_Nam_Province-Hotels.html");
...
//echo $address;
    file_put_contents("data/Vietnamese.txt",$address.PHP_EOL,FILE_APPEND);
}
