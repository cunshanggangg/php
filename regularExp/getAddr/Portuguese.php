...
set_time_limit(0);
//里斯本酒店 Lisbon
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g189158-Lisbon_Lisbon_District_Central_Portugal-Hotels.html");
...
//echo $address;
    file_put_contents("data/Portuguese.txt",$address.PHP_EOL,FILE_APPEND);
}
