...
set_time_limit(0);
//克拉科夫酒店 Krakow
//$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g274772-Krakow_Lesser_Poland_Province_Southern_Poland-Hotels.html");
//扎科帕内酒店 Zakopane
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g274793-Zakopane_Lesser_Poland_Province_Southern_Poland-Hotels.html");
...
//echo $address;
    file_put_contents("data/Polish.txt",$address.PHP_EOL,FILE_APPEND);
}
