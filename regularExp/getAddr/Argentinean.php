 ...
 */
set_time_limit(0);
//布宜诺斯艾利斯酒店 Buenos Aires
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g312741-Buenos_Aires_Capital_Federal_District-Hotels.html");
...
//echo $address;
    file_put_contents("data/Argentinean.txt",$address.PHP_EOL,FILE_APPEND);
}
