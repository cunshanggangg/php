...
set_time_limit(0);
//匈牙利酒店 Hungary
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g274887-Budapest_Central_Hungary-Hotels.html");
...
//echo $address;
    file_put_contents("data/Hungarian.txt",$address.PHP_EOL,FILE_APPEND);
}
