...
set_time_limit(0);
//伊斯坦布尔酒店 Istanbul
//$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g293974-Istanbul-Hotels.html");
//阿兰亚酒店 Alanya
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g297961-Alanya_Turkish_Mediterranean_Coast-Hotels.html");
...
//echo $address;
    file_put_contents("data/Turk.txt",$address.PHP_EOL,FILE_APPEND);
}
