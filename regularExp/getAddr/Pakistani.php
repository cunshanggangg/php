...
set_time_limit(0);
//拉合尔酒店 Lahore
//$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g295413-Lahore_Punjab_Province-Hotels.html");
//伊斯兰堡酒店 Islamabad
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g293960-Islamabad_Islamabad_Capital_Territory-Hotels.html");
...
//echo $address;
    file_put_contents("data/Pakistani.txt",$address.PHP_EOL,FILE_APPEND);
}
