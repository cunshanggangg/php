...
set_time_limit(0);
//暹粒酒店 Siem Reap
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g297390-Siem_Reap_Siem_Reap_Province-Hotels.html");
...
//echo $address;
    file_put_contents("data/Kampuchean.txt",$address.PHP_EOL,FILE_APPEND);
}
