...
set_time_limit(0);
//圣地亚哥酒店 Santiago
$str = file_get_contents("https://www.tripadvisor.cn/Hotels-g294305-Santiago_Santiago_Metropolitan_Region-Hotels.html");
...
//echo $address;
    file_put_contents("data/Chilean.txt",$address.PHP_EOL,FILE_APPEND);
}
